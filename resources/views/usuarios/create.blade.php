        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <form method="post" action="{{ route('usuarios.store') }}" class="p-4">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group @error('cpf') has-danger @enderror">
                                    <input type="text" class="form-control form-control-alternative @error('cpf') is-invalid @enderror"
                                           id="cpf" name="cpf" value="{{ old('cpf') }}" placeholder="Ex: 123.456.789-01" maxlength="14" autofocus>
                                    @error('cpf')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group @error('usuario') has-danger @enderror">
                                    <input type="text" class="form-control form-control-alternative @error('usuario') is-invalid @enderror"
                                           id="usuario" name="usuario" value="{{ old('usuario') }}" placeholder="">
                                    @error('usuario')
                                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group @error('nome') has-danger @enderror">
                                    <input type="text" class="form-control form-control-alternative @error('nome') is-invalid @enderror"
                                           id="nome" name="nome" value="{{ old('nome') }}" placeholder="">
                                    @error('nome')
                                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
